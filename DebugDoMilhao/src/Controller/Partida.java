...
public class Partida {
    ...
    private void gerarQuestoesPadrao() {
        Questão q1 = new Questão("Qual erro ocorre ao acessar um índice inexistente em um Array?");
        ...
        Questão q2 = new Questão("Qual palavra-chave impede que uma classe seja herdada em Java?");
        ...
        Questão q3 = new Questão("PERGUNTA DO MILHÃO: Qual das opções NÃO é uma interface do Java Collections?");
    ...
    public Questão getQuestaoAtual() {
